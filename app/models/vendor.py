...
class Vendor(Base):
    ...
    banking_fingerprints: Mapped[list[str]] = mapped_column(
        JSON, default=list
    )
    """
    ...
    z_score_mean: Mapped[Decimal | None] = mapped_column(
    ...
    z_score_stddev: Mapped[Decimal | None] = mapped_column(
        Numeric(12, 2), default=None
    )
    """
    ...
    def __repr__(self) -> str:
        return (
            f"<Vendor(vendor_name='{self.vendor_name}', "
            f"invoice_count={self.invoice_count})>"
        )
