...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "document_type",
            sa.Enum("RECEIPT", "INVOICE", "STATEMENT", name="documenttype"),
            nullable=False,
        ),
        ...
        sa.Column(
            "status",
            sa.Enum(
                "PROCESSED", "NEEDS_REVIEW", "QUARANTINED", "UNRECONCILED", name="processingstatus"
            ),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "severity",
            sa.Enum("CRITICAL", "HIGH", "MEDIUM", "LOW", name="anomalyseverity"),
            nullable=False,
        ),
